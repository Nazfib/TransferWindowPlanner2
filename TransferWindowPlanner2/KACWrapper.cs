...
public class KACWrapper
{
    ...
    public static bool InitKACWrapper()
    {
        ...
        //find the base type
        AssemblyLoader.loadedAssemblies.TypeOperation(
            t =>
            {
                if (t.FullName == "KerbalAlarmClock.KerbalAlarmClock") { KACType = t; }
            });
        ...
        try { actualKAC = KACType.GetField("APIInstance", BindingFlags.Public | BindingFlags.Static).GetValue(null); }
        catch (Exception)
        {
            NeedUpgrade = true;
    ...
    public class KACAPI
    {
        internal KACAPI(object KAC)
        {
            ...
            onAlarmStateChangedEvent = KACType.GetEvent(
                "onAlarmStateChanged", BindingFlags.Public | BindingFlags.Instance);
            ...
            DrawAlarmActionChoiceMethod = KACType.GetMethod(
                "DrawAlarmActionChoiceAPI", BindingFlags.Public | BindingFlags.Instance);
        ...
        public bool APIReady
        {
            get
            {
                if (APIReadyField == null) { return false; }
        ...
        /// <param name="AlarmID">Unique ID of the alarm</param>
        /// <returns>Success of the deletion</returns>
        internal bool DrawAlarmActionChoice(
            ref AlarmActionEnum Choice, string LabelText, int LabelWidth, int ButtonWidth)
        {
            var InValue = (int)Choice;
            var OutValue = (int)DrawAlarmActionChoiceMethod.Invoke(
                actualKAC, new object[] { InValue, LabelText, LabelWidth, ButtonWidth });
        ...
        public class KACAlarm
        {
            ...
            public AlarmActionEnum AlarmAction
            {
                get => (AlarmActionEnum)ActionActionProperty.GetValue(actualAlarm);
                set => ActionActionProperty.SetValue(actualAlarm, (int)value);
            }
    ...
    internal static void LogFormatted(string Message, params object[] strParams)
    {
        ...
        var strMessageLine = string.Format(
            "{0},{2}-{3},{1}",
